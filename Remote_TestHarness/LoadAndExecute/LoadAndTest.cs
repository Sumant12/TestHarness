...
namespace TestHarness
{
    public class LoadAndTest : MarshalByRefObject, ILoadAndTest
    {
        ...
        {
            loadPath_ = path;
            Console.WriteLine("Loading the Path");
            Console.WriteLine(loadPath_);
        }
        ...
        public ITestResults test(IRequestInfo testRequest) { 
         Console.WriteLine("Executing the Tests"); Console.WriteLine();
            ...
            foreach (ITestInfo test in testRequest.requestInfo)
                ...
                try { 
                    ...
                    ITest tdr = null; string testDriverName = ""; string fileName = "";
            ...
            testResults_.dateTime = DateTime.Now; testResults_.testKey = System.IO.Path.GetFileName(loadPath_);
            return testResults_;
        }
